...
def simplexSecondPhase(matriz,debug):
    ...
    while(not(paradaOtimo(problema[0]))):
        ...
        aux = variaveis_naoBasicas[candidato]
        variaveis_naoBasicas[candidato]=variaveis_Basicas[saindo]
        variaveis_Basicas[saindo]=aux
...
def main():
    ...
    #    simplexSecondPhase(matriz,False);
    #else:
    #    simplexSecondPhase(matriz[1:],False);
